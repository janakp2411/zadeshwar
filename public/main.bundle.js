...
// module
exports.push([module.i, "body {\r\n    background-color: rgba(255, 181, 90, .7) !important;\r\n}", ""]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_forgotpassword_forgotpassword_component__ = __webpack_require__("../../../../../src/app/components/forgotpassword/forgotpassword.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_resetpassword_resetpassword_component__ = __webpack_require__("../../../../../src/app/components/resetpassword/resetpassword.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_primeng_accordion__ = __webpack_require__("../../../../primeng/accordion.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_primeng_inputmask__ = __webpack_require__("../../../../primeng/inputmask.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_primeng_inputmask___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_20_primeng_inputmask__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    { path: 'forgotpassword', component: __WEBPACK_IMPORTED_MODULE_13__components_forgotpassword_forgotpassword_component__["a" /* ForgotpasswordComponent */] },
    { path: 'resetpassword', component: __WEBPACK_IMPORTED_MODULE_14__components_resetpassword_resetpassword_component__["a" /* ResetpasswordComponent */] }
];
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_13__components_forgotpassword_forgotpassword_component__["a" /* ForgotpasswordComponent */],
                __WEBPACK_IMPORTED_MODULE_14__components_resetpassword_resetpassword_component__["a" /* ResetpasswordComponent */]
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_20_primeng_inputmask__["InputMaskModule"],
...
module.exports = "<h2 class=\"page-header\">Forgot Password</h2>\r\n<form (submit)=\"onForgotPassword()\">\r\n  <div class=\"form-group\">\r\n    <label>Email</label>\r\n    <input type=\"text\" autocomplete=\"off\" class=\"form-control\" placeholder=\"Enter your emial address\" [(ngModel)]=\"email\" name=\"email\">\r\n  </div>\r\n  <input type=\"submit\" autocomplete=\"off\" class=\"btn btn-primary\" value=\"Submit\">\r\n</form>"
...
var ForgotpasswordComponent = (function () {
    function ForgotpasswordComponent(authService, validateService, router, flashMessage) {
    ...
    ForgotpasswordComponent.prototype.onForgotPassword = function () {
        ...
        this.authService.forgotPasswordService(email).subscribe(function (data) {
            window.scrollTo(0, 0);
            if (data.success) {
                _this.flashMessage.show('Please go to your email and click on the link to change password', {
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>Welcome to Zadeshwar Group</h1>\n  <p class=\"lead\">Currently our app is under development so feel free to give us suggestions!</p>\n  <p class=\"lead\">We will appreciate for your suggestions</p>\n  <p class=\"lead\">Email Us: Jayzadeshwar@gmail.com</p>\n  <div>\n    <a class=\"btn btn-primary\" [routerLink]=\"['/register']\">Register</a>\n    <a class=\"btn btn-dark\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n<!-- <div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Express Backend</h3>\n    <p>A rock solid Node.js/Express server using Mongoose to organize models and query the database</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Angular-CLI</h3>\n    <p>Angular-CLI to generate components, services and more. Local dev server and easy compilation</p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>JWT Tokens</h3>\n    <p>Full featured authentication using JSON web tokens. Login and store user data</p>\n  </div>\n</div> -->\n"
...
// module
exports.push([module.i, "nav {\r\n    background-color: rgba(0, 0, 0, 0.8) !important;\r\n    box-shadow: #292b2c -2px 5px 17px;\r\n}", ""]);
...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getProfile().subscribe(function (profile) {
            ...
            _this.userDetailsData = profile && profile.userDetails || [{}];
        }, function (err) {
            console.log(err);
            return false;
        });
    ...
    ProfileComponent.prototype.onUserDetailsSubmit = function (details) {
        var _this = this;
        var userData = details.filter(function (data) { return Object.keys(data).length; });
        this.authService.addUserDetails({ userDetails: { userDetails: userData, id: this.user._id } }).subscribe(function (data) {
            window.scrollTo(0, 0);
            if (data.success) {
                _this.userDetailsData = userData;
...
module.exports = "<h2 class=\"page-header\">Register</h2>\n<form (submit)=\"onRegisterSubmit()\">\n  <div class=\"form-group\">\n    <label>Name</label>\n    <input type=\"text\" autocomplete=\"off\" [(ngModel)]=\"name\" name=\"name\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n    <label>Email</label>\n    <input type=\"text\" autocomplete=\"off\" [(ngModel)]=\"email\" name=\"email\" class=\"form-control\" >\n  </div>\n  <div class=\"form-group\">\n    <label>Password</label>\n    <input type=\"password\" autocomplete=\"off\" [(ngModel)]=\"password\" name=\"password\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n    <label>Confirm Password</label>\n    <input type=\"password\" autocomplete=\"off\" [(ngModel)]=\"confirmPassword\" name=\"confirmPassword\" class=\"form-control\">\n  </div>\n  <input type=\"submit\" class=\"btn btn-primary\" value=\"Submit\">\n  <span class=\"ml-4\"><a class=\"link text-primary\" [routerLink]=\"['/login']\">Already Registered ?</a></span>\n</form>\n"
...
module.exports = "<h2 class=\"page-header\">Reset Password</h2>\r\n<form (submit)=\"onResetPassword()\">\r\n  <div class=\"form-group\">\r\n    <label>New Password</label>\r\n    <input type=\"password\" autocomplete=\"off\" class=\"form-control\" placeholder=\"Enter New Password\" [(ngModel)]=\"newPassword\" name=\"newPassword\">\r\n  </div>\r\n  <div class=\"form-group\">\r\n    <label>Confirm Password</label>\r\n    <input type=\"password\" autocomplete=\"off\" class=\"form-control\" placeholder=\"Re-enter New Password\" [(ngModel)]=\"confirmNewPassword\" name=\"confirmNewPassword\">\r\n  </div>\r\n  <input type=\"submit\" class=\"btn btn-primary\" value=\"Submit\">\r\n</form>"
...
var ResetpasswordComponent = (function () {
    ...
    ResetpasswordComponent.prototype.getCookie = function (cname) {
        var name = cname + "=";
    ...
    ResetpasswordComponent.prototype.onResetPassword = function () {
        var _this = this;
        var newPass = this.newPassword.trim();
        var confirmPass = this.confirmNewPassword.trim();
        ...
        if (newPass != confirmPass) {
            ...
            this.authService.resetPasswordService(pass).subscribe(function (data) {
                if (data.success) {
                    _this.flashMessage.show('Password changed successfully', {
                        cssClass: 'alert-success',
                        timeout: 5000
                    });
                    _this.router.navigate(['login']);
...
var AuthService = (function () {
    ...
    AuthService.prototype.forgotPasswordService = function (email) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        var ep = this.endPointDomain + 'users/forgotpassword';
        return this.http.post(ep, email, { headers: headers })
            .map(function (res) { return res.json(); });
    };
    AuthService.prototype.resetPasswordService = function (password) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        var ep = this.endPointDomain + 'users/resetpassword';
